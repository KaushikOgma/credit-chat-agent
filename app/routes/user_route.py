...
async def get_users(
    ...
    company: str = Query(None, description="company"),
    ...
    **Args:**
    ...
    - `company` (str): Filter the users by company of the request.
    ...
    **Returns:**
    ...
    try:
        ...
        async with db_instance as db:
            return await user_controller.get_users(db, userId, startDate, endDate, name, email, company, sort_params)
